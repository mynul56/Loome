        ...
        <div className="fixed bottom-24 right-6 w-[350px] md:w-[400px] h-[500px] bg-white z-[100] border-4 border-black sport-shadow flex flex-col overflow-hidden animate-fade-in-up">
          ...
          <div className="bg-black text-white p-4 flex items-center justify-between border-b-4 border-primary">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-heading text-lg uppercase leading-none">
                  Pitch Assistant
                </h3>
          ...
          >
            {messages.length === 0 && (
              <div className="h-full flex flex-col items-center justify-center text-center p-6 space-y-4">
                ...
                <p className="text-xs font-bold text-gray-500 uppercase leading-relaxed">
                  Ask me for match predictions, kit styling advice, or find your
                  perfect 2026 squad.
                </p>
                <div className="grid grid-cols-1 gap-2 w-full mt-4">
                  <button
                    onClick={() => setInput("Who will win the World Cup 2026?")}
                    className="text-[10px] font-bold border-2 border-gray-200 p-2 hover:border-black hover:bg-white transition-colors uppercase"
                  >
                    "Who will win World Cup 2026?"
                  </button>
                  <button
                    onClick={() =>
                      setInput("What kit should I wear for a stadium match?")
                    }
                    className="text-[10px] font-bold border-2 border-gray-200 p-2 hover:border-black hover:bg-white transition-colors uppercase"
                  >
                    "Best kit for a stadium match?"
                  </button>
                </div>
              </div>
            )}
            ...
            {messages.map((m, i) => (
              ...
              >
                <div
                  className={`max-w-[85%] p-3 border-2 font-bold text-xs uppercase tracking-tight
                  ${
                    m.role === "user"
