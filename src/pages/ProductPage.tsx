        ...
        if (data && data.images.length > 0) {
          const resolved = await Promise.all(
            data.images.map((path) =>
              mediaService.resolveProductImageUrl(path),
            ),
          );
          setDisplayImages(resolved);
          setActiveImage(resolved[0] || "");
        }
      } catch (err) {
    ...
    return (
      <Layout>
        <div className="pt-32 pb-20 text-center">
          <h1 className="text-6xl font-heading uppercase text-black mb-6">
            Kit Not Found
          </h1>
          <Link
            to="/shop"
            className="bg-black text-white px-8 py-4 font-bold uppercase hover:bg-primary hover:text-black transition-colors"
          >
            Return to Pitch
          </Link>
        </div>
    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen pb-20">
        ...
        <div className="bg-black text-white px-6 lg:px-12 py-4 flex items-center justify-between border-b-4 border-primary">
          ...
          <span className="font-heading uppercase text-gray-500 tracking-widest">
            {product.team}
          </span>
        </div>
            ...
            <div className="lg:col-span-6 flex flex-col justify-center">
              <div className="mb-8 border-b-4 border-black pb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="bg-gray-200 text-black px-3 py-1 font-bold text-xs uppercase tracking-widest">
                    {product.type} KIT
                  </span>
                </div>
                ...
                <div className="flex gap-4 items-end font-jersey">
                  {product.discountPrice ? (
                    <>
                      ...
                      <span className="text-3xl text-gray-400 line-through leading-none mb-1">
                        ৳{product.price}
                      </span>
                    </>
                  ) : (
              ...
              <div className="space-y-8 mb-10 bg-gray-50 p-8 border-2 border-dashed border-gray-300">
                ...
                <div>
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <button className="text-sm font-bold text-black border-b-2 border-black hover:text-primary hover:border-primary transition-colors">
                      Size Guide
                    </button>
                  </div>
                ...
                {/* Quantity */}
                <div>
                  <span className="font-heading text-2xl uppercase block mb-4">
                    Quantity
                  </span>
